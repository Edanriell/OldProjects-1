...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    key: "switchModule",
    value: function switchModule(module) {
      var _this2 = this;
    ...
    value: function bindTriggers() {
      ...
      this.switchModule(this.prevModule);
      this.switchModule(this.nextModule);
    }
  }, {
    key: "render",
...
function (_Slider) {
  ...
  function MiniSlider(container, next, prev, activeClass, animate, autoplay, paused) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, activeClass, animate, autoplay, paused));
  }
...
var Slider = function Slider() {
  ...
  this.slideIndex = 1;
  this.paused = paused, this.nextModule = document.querySelectorAll(nextModule), this.prevModule = document.querySelectorAll(prevModule);
};
